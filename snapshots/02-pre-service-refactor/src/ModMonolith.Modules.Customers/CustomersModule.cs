...
public sealed class CustomersModule : IModule
{
    ...
    public void MapEndpoints(IEndpointRouteBuilder endpoints)
    {
        ...
        group.MapGet("/customers/{id:guid}", async (Guid id, ICustomerDirectory customerDirectory, CancellationToken cancellationToken) =>
        {
            var customer = await customerDirectory.GetByIdAsync(id, cancellationToken);
